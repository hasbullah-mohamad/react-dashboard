...
var ListInstanceHistory = function (_React$Component) {
  _inherits(ListInstanceHistory, _React$Component);

  function ListInstanceHistory(props) {
    _classCallCheck(this, ListInstanceHistory);

    var _this = _possibleConstructorReturn(this, (ListInstanceHistory.__proto__ || Object.getPrototypeOf(ListInstanceHistory)).call(this, props));
    ...
    _this.WrappedListHistory = (0, _withRedux2.default)(_List2.default, {
      reducer: _this.state.reducer,
      name: _this.state.name + 'history' + props.match.params.histId,
      endpoint: _this.state.reducer + '/' + _this.state.name + 'history/',
      query: _defineProperty({}, _this.state.name, props.match.params.histId),
      title: _this.state.title + ' History',
      hoc: _withFilter2.default,
      editable: true
    });
    _this.WrappedInstanceHistory = (0, _withRedux2.default)(_Instance2.default, {
      reducer: _this.state.reducer,
      name: _this.state.name + 'history' + props.match.params.histId,
      endpoint: _this.state.reducer + '/' + _this.state.name + 'history/' + props.match.params.id + '/',
      query: {},
      title: _this.state.title + ' History Details'
    });
    return _this;
  }

  _createClass(ListInstanceHistory, [{
    key: 'selectComponent',
    value: function selectComponent() {
      var params = this.props.match.params;

      if (params.histId && params.id) {
        return _react2.default.createElement(this.WrappedInstanceHistory, this.props);
      } else if (params.histId) {
        return _react2.default.createElement(this.WrappedListHistory, this.props);
      } else if (params.id) {
  ...
  return ListInstanceHistory;
}(_react2.default.Component);

exports.default = ListInstanceHistory;